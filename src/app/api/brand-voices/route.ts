...
export async function POST(req: Request, res: Response) {
    return brandVoiceController.createBrandVoice(req, res);
}

// export async function PUT(req: Request, res: Response) {
//     return brandVoiceController.updateBrandVoice(req, res);
// }

export async function DELETE(req: Request, res: Response) {
    return brandVoiceController.deleteBrandVoice(req, res);
}