      ...
      <div className="flex-1 py-4">
        ...
        <div className="mb-6">
          ...
          <select
            id="type"
            {...register('type')}
            className={`mt-1 block w-full rounded-md border ${errors.type ? 'border-red-500' : 'border-gray-300'
        ...
        <div className="mb-4">
          ...
          <select
            id="category"
            {...register('category')}
            className={`mt-1 block w-full rounded-md border ${errors.category ? 'border-red-500' : 'border-gray-300'
              } shadow-sm h-12 px-3 focus:outline-none focus:ring-primary focus:border-primary`}
